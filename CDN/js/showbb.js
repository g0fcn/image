function getbbdata(){
  var bbsurl = "https://6363-ccknbc-154167-1300914868.tcb.qcloud.la/json/bber.json" //这里填写你的api地址
  ...
  if (httpRequest.readyState == 4 && httpRequest.status == 200) {
      ...
      saveToLocal.set('ccknbc-bb', JSON.stringify(bbArray), 5 / (60 * 24))
      const data = saveToLocal.get('ccknbc-bb');
