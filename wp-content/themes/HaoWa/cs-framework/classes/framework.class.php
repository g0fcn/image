...
class CSFramework extends CSFramework_Abstract {
  ...
  public function admin_page() {
    ...
    echo '<div class="cs-framework cs-option-framework">';
      ...
      echo '<h1>'.wp_get_theme()->display('Name').'<small style="color:#ff0000;">  '.$version.'</small> <small>by Wazhuti.com</small></h1>';
      echo '<fieldset>';
      ...
      echo '<div class="cs-block-left">www.Wazhuti.com</div>';
      echo '<div class="cs-block-right">挖主题 | 专注用户体验设计和互联网品牌建设</div>';
      echo '<div class="clear"></div>';
